  ...
  Widget _buildEmptyState(BuildContext context) {
    ...
    return LayoutBuilder(
      ...
      builder: (context, constraints) {
        ...
        final flashOpacity = math.max(0, math.sin(_buttonAnimController.value * math.pi));
        return Stack(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color:
                              theme.colorScheme.primary.withOpacity(0.08 + (0.04 * wave)),
                          blurRadius: 30,
                          spreadRadius: 4,
                        ),
                      ],
          ...
          children: List.generate(_scanTips.length, (index) {
            ...
            return AnimatedSlide(
              ...
              child: AnimatedContainer(
                duration: const Duration(milliseconds: 400),
                curve: Curves.easeOutCubic,
                margin: EdgeInsets.only(right: index == _scanTips.length - 1 ? 0 : 12),
...
class _ScanFramePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    void drawCorner(Offset origin, {required bool horizontalPositive, required bool verticalPositive}) {
    ...
    drawCorner(rrect.topLeft, horizontalPositive: true, verticalPositive: true);
    drawCorner(rrect.topRight, horizontalPositive: false, verticalPositive: true);
    drawCorner(rrect.bottomLeft, horizontalPositive: true, verticalPositive: false);
    drawCorner(rrect.bottomRight, horizontalPositive: false, verticalPositive: false);
  }
