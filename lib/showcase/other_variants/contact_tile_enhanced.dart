...
import 'theme_constants_enhanced.dart';

class ContactTileEnhanced extends StatefulWidget {
  ...
  @override
  State<ContactTileEnhanced> createState() => _ContactTileEnhancedState();
}

class _ContactTileEnhancedState extends State<ContactTileEnhanced>
  ...
  @override
  void didUpdateWidget(ContactTileEnhanced oldWidget) {
                ...
                child: AnimatedBuilder(
                  ...
                  builder: (context, child) {
                    ...
                    final Color baseSurface = isSelected
                        ? theme.colorScheme.primaryContainer.withOpacity(0.96)
                    ...
                    final double blurSigma =
                        DesignTokensEnhanced.blurSigma + (shimmerValue * 6);
                    final double borderOpacity =
                        0.14 + (shimmerValue * (isSelected ? 0.25 : 0.18));
                    final List<BoxShadow> shadows = [
                      BoxShadow(
                        color: theme.colorScheme.primary.withOpacity(
                            isSelected ? 0.35 : 0.08 + (0.14 * shimmerValue)),
                    ...
                    return AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(
                            DesignTokensEnhanced.borderRadiusExtraLarge),
                        border: Border.all(
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: InkWell(
        ...
        borderRadius:
            BorderRadius.circular(DesignTokensEnhanced.borderRadiusExtraLarge),
        child: Padding(
              ...
              Hero(
                ...
                child: inSelectionMode
                    ...
                    : Container(
                        ...
                        decoration: BoxDecoration(
                          gradient:
                              DesignTokensEnhanced.avatarGradient(context),
                          shape: BoxShape.circle,
                          boxShadow: DesignTokensEnhanced.avatarShadow(context),
                        ),
                        child: Center(
                          child: Text(
                            initials,
