...
class ScanScreenVariantE extends ConsumerStatefulWidget {
  const ScanScreenVariantE({super.key});

  @override
  ConsumerState<ScanScreenVariantE> createState() => _ScanScreenVariantEState();
}

class _ScanScreenVariantEState extends ConsumerState<ScanScreenVariantE>
