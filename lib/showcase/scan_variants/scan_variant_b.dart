...
class ScanScreenVariantB extends ConsumerStatefulWidget {
  const ScanScreenVariantB({super.key});

  @override
  ConsumerState<ScanScreenVariantB> createState() => _ScanScreenVariantBState();
}

class _ScanScreenVariantBState extends ConsumerState<ScanScreenVariantB>
                    ...
                    Row(
                      children: [
                        ...
                        Expanded(
                          flex: 2,
                          child: FilledButton.icon(
                            onPressed: _isProcessing || _image == null
                                ? null
                                : _processImage,
