...
class HomeScreenVariantA extends ConsumerStatefulWidget {
  const HomeScreenVariantA({super.key});

  @override
  ConsumerState<HomeScreenVariantA> createState() => _HomeScreenVariantAState();
}

class _HomeScreenVariantAState extends ConsumerState<HomeScreenVariantA>
