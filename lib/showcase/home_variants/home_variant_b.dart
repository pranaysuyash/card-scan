...
class HomeScreenVariantB extends ConsumerStatefulWidget {
  const HomeScreenVariantB({super.key});

  @override
  ConsumerState<HomeScreenVariantB> createState() => _HomeScreenVariantBState();
}

class _HomeScreenVariantBState extends ConsumerState<HomeScreenVariantB>
