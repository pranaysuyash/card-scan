...
class ReviewScreenVariantC extends ConsumerStatefulWidget {
  final String? imagePath;
  final List<String> ocrLines;
  final Map<String, dynamic>? parsedData;

  const ReviewScreenVariantC({
    super.key,
    this.imagePath,
  ...
  @override
  ConsumerState<ReviewScreenVariantC> createState() =>
      _ReviewScreenVariantCState();
}

class _ReviewScreenVariantCState extends ConsumerState<ReviewScreenVariantC>
        ...
        child: Column(
          ...
          children: [
            ...
            AnimatedSwitcher(
              ...
              child: hasSuggestion &&
                      controller.text.trim() != normalizedSuggestion
                  ? Align(
