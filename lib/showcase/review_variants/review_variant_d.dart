...
class ReviewScreenVariantD extends ConsumerStatefulWidget {
  final String? imagePath;
  final List<String> ocrLines;
  final Map<String, dynamic>? parsedData;

  const ReviewScreenVariantD({
    super.key,
    this.imagePath,
  ...
  @override
  ConsumerState<ReviewScreenVariantD> createState() => _ReviewScreenVariantDState();
}

class _ReviewScreenVariantDState extends ConsumerState<ReviewScreenVariantD> {
